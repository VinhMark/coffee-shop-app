...
const PaymentScreen = ({navigation, route}: any) => {
  const {calculateCartPrice, addToOrderHistoryListFromCart} = useStore(
    (state: any) => state,
  );
              ...
              <View style={styles.creditCardBG}>
                <LinearGradient
                  ...
                  <View style={styles.creditCardNumberContainer}>
                    <Text style={styles.creditCardNumber}>2344</Text>
                    <Text style={styles.creditCardNumber}>2344</Text>
                    <Text style={styles.creditCardNumber}>2344</Text>
                    <Text style={styles.creditCardNumber}>2344</Text>
                  </View>
                  ...
                  <View style={styles.creditCardRow}>
                    <View style={styles.creditCardNameContainer}>
                      ...
                      <Text style={styles.creditCardNameTitle}>Van Vinh</Text>
                    </View>
                    <View style={styles.creditCardDateContainer}>
                      <Text style={styles.creditCardNameSubTitle}>
                        Expiry Date
                      </Text>
                      <Text style={styles.creditCardNameTitle}>03/23</Text>
                    </View>
                  </View>
                </LinearGradient>
              </View>
